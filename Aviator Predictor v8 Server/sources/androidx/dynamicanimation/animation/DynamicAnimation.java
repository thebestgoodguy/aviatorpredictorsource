...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    private void endAnimationInternal(boolean z) {
        ...
        this.mLastFrameTime = 0L;
        this.mStartValueIsSet = false;
        for (int r2 = 0; r2 < this.mEndListeners.size(); r2++) {
            if (this.mEndListeners.get(r2) != null) {
                this.mEndListeners.get(r2).onAnimationEnd(this, z, this.mValue, this.mVelocity);
            }
        }
    ...
    void setPropertyValue(float f) {
        ...
        for (int r2 = 0; r2 < this.mUpdateListeners.size(); r2++) {
            if (this.mUpdateListeners.get(r2) != null) {
                this.mUpdateListeners.get(r2).onAnimationUpdate(this, this.mValue, this.mVelocity);
            }
        }

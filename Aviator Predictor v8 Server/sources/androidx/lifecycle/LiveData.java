...
public abstract class LiveData<T> {
    ...
    void changeActiveCounter(int change) {
        ...
        while (true) {
            try {
                int r3 = this.mActiveCount;
                if (previousActiveCount != r3) {
                    boolean needToCallActive = previousActiveCount == 0 && r3 > 0;
                    boolean needToCallInactive = previousActiveCount > 0 && r3 == 0;
                    previousActiveCount = r3;
                    if (needToCallActive) {
                        onActive();

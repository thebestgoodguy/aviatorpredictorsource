...
public class FlatBufferBuilder {
    ...
    public void startTable(int numfields) {
        notNested();
        int[] r0 = this.vtable;
        if (r0 == null || r0.length < numfields) {
    ...
    public int endTable() {
        ...
        while (i >= 0) {
            int[] r4 = this.vtable;
            short off = (short) (r4[i] != 0 ? vtableloc - r4[i] : 0);
            addShort(off);
            i--;
        }
        ...
        if (existing_vtable != 0) {
            ...
            int r6 = this.num_vtables;
            int[] r7 = this.vtables;
            if (r6 == r7.length) {
                this.vtables = Arrays.copyOf(r7, r6 * 2);
            }
            int[] r62 = this.vtables;
            int r72 = this.num_vtables;
            this.num_vtables = r72 + 1;
            r62[r72] = offset();
            ByteBuffer byteBuffer = this.bb;

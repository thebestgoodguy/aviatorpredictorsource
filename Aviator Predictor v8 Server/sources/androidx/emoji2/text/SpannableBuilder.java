...
public final class SpannableBuilder extends SpannableStringBuilder {
    ...
    public <T> T[] getSpans(int r5, int r6, Class<T> cls) {
        if (isWatcher((Class<?>) cls)) {
            WatcherWrapper[] watcherWrapperArr = (WatcherWrapper[]) super.getSpans(r5, r6, WatcherWrapper.class);
            T[] tArr = (T[]) ((Object[]) Array.newInstance((Class<?>) cls, watcherWrapperArr.length));
            for (int r2 = 0; r2 < watcherWrapperArr.length; r2++) {
                tArr[r2] = watcherWrapperArr[r2].mObject;
            }
            return tArr;
        }
        return (T[]) super.getSpans(r5, r6, cls);
    }

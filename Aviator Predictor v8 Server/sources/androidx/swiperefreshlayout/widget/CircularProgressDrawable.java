...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public void setBackgroundColor(int r5) {
        this.mRing.setBackgroundColor(r5);
        invalidateSelf();
    }
    ...
    public void setColorSchemeColors(@NonNull int... r5) {
        this.mRing.setColors(r5);
    ...
    private int evaluateColorChange(float f, int r19, int r20) {
        return ((((r19 >> 24) & 255) + ((int) (f * (((r20 >> 24) & 255) - r12)))) << 24) | ((((r19 >> 16) & 255) + ((int) (f * (((r20 >> 16) & 255) - r12)))) << 16) | ((((r19 >> 8) & 255) + ((int) (f * (((r20 >> 8) & 255) - r12)))) << 8) | ((r19 & 255) + ((int) (f * ((r20 & 255) - r12))));
    }
    ...
    private static class Ring {
        ...
        void setColor(int r5) {
            this.mCurrentColor = r5;
        }

        void setBackgroundColor(int r5) {
            this.mCirclePaint.setColor(r5);
        }

...
public abstract class VersionedParcel {
    ...
    public <T extends Parcelable> T readParcelable(T t, int r3) {
        if (!readField(r3)) {
            return t;
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public <K, V> Map<K, V> readMap(Map<K, V> map, int r9) {
        if (!readField(r9)) {
            return map;
        }
        int readInt = readInt();
    ...
    public <T> T[] readArray(T[] tArr, int r3) {
        if (!readField(r3)) {
            return tArr;
        }
    ...
    public <T extends VersionedParcelable> T readVersionedParcelable(T t, int r3) {
        if (!readField(r3)) {
            return t;
        }

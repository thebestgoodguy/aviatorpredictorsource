...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public boolean readField(int fieldId) {
        while (this.mNextRead < this.mEnd) {
            ...
            if (String.valueOf(r0).compareTo(String.valueOf(fieldId)) > 0) {
                return false;
            }
    ...
    public void closeField() {
        ...
        if (r0 >= 0) {
            int currentFieldPosition = this.mPositionLookup.get(r0);
    ...
    protected VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, dataPosition, r0, this.mPrefix + "  ", this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }

...
public class ConstraintWidget {
    ...
    public int getOptimizerWrapWidth() {
        ...
        if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            int r1 = this.mMatchConstraintMaxWidth;
            if (r1 > 0 && r1 < w) {
    ...
    public int getOptimizerWrapHeight() {
        ...
        if (this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            int r1 = this.mMatchConstraintMaxHeight;
            if (r1 > 0 && r1 < h) {
    ...
    public void setFrame(int left, int top, int right, int bottom) {
        ...
        this.mWidth = w;
        this.mHeight = h;
        int r2 = this.mMinHeight;
        if (h < r2) {
            this.mHeight = r2;
        }
        int r22 = this.mMinWidth;
        if (w < r22) {
            this.mWidth = r22;
        }
        ...
        int r23 = this.mWidth;
        if (w != r23) {
            this.mWidthOverride = r23;
        }
        int r24 = this.mHeight;
        if (h != r24) {
            this.mHeightOverride = r24;
        }
    }
    ...
    */
    ...
    public void setupDimensionRatio(boolean hParentWrapContent, boolean vParentWrapContent, boolean horizontalDimensionFixed, boolean verticalDimensionFixed) {
        ...
        if (this.mResolvedDimensionRatioSide == -1) {
            int r0 = this.mMatchConstraintMinWidth;
            if (r0 > 0 && this.mMatchConstraintMinHeight == 0) {
                this.mResolvedDimensionRatioSide = 0;
            } else if (r0 == 0 && this.mMatchConstraintMinHeight > 0) {
                this.mResolvedDimensionRatio = 1.0f / this.mResolvedDimensionRatio;
                this.mResolvedDimensionRatioSide = 1;
            }
        }
    ...
    */
    ...
    public void copy(ConstraintWidget src, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        int[] r0 = this.mResolvedMatchConstraintDefault;
        int[] r1 = src.mResolvedMatchConstraintDefault;
        r0[0] = r1[0];
        r0[1] = r1[1];
        ...
        int[] r02 = src.mMaxDimension;
        this.mMaxDimension = Arrays.copyOf(r02, r02.length);

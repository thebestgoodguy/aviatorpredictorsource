...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r0 = new int[State.Constraint.values().length];
            $SwitchMap$androidx$constraintlayout$core$state$State$Constraint = r0;
            try {
                r0[State.Constraint.LEFT_TO_LEFT.ordinal()] = 1;
    ...
    */
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        int r0 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()];
    ...
    public void apply() {
        ...
        int r0 = this.mHorizontalChainStyle;
        if (r0 != 0) {
            this.mConstraintWidget.setHorizontalChainStyle(r0);
        }
        int r02 = this.mVerticalChainStyle;
        if (r02 != 0) {
            this.mConstraintWidget.setVerticalChainStyle(r02);
        }

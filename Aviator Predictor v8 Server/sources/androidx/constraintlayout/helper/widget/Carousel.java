...
public class Carousel extends MotionHelper {
    ...
    private boolean updateViewVisibility(View view, int visibility) {
        ...
        for (int r0 : constraintSets) {
            needsMotionSceneRebuild |= updateViewVisibility(r0, view, visibility);
        }
    ...
    public void updateItems() {
        ...
        for (int i = 0; i < viewCount; i++) {
            ...
            if (this.infiniteCarousel) {
                if (index < 0) {
                    int r6 = this.emptyViewBehavior;
                    if (r6 != 4) {
                        updateViewVisibility(view, r6);
                    } else {
                        updateViewVisibility(view, 0);
                    }
                    ...
                    int r62 = this.emptyViewBehavior;
                    if (r62 != 4) {
                        updateViewVisibility(view, r62);
                    } else {
                        updateViewVisibility(view, 0);
                    }

...
public class CircularFlow extends VirtualLayout {
    ...
    public int removeView(View view) {
        ...
        int[] r2 = this.mRadius;
        if (index < r2.length) {
            this.mRadius = removeRadius(r2, index);
            this.mCountRadius--;
        }
        anchorReferences();
        return index;
    ...
    private void addRadius(String radiusString) {
        int[] r0;
        if (radiusString == null || radiusString.length() == 0 || this.myContext == null || (r0 = this.mRadius) == null) {
            return;
        }
        if (this.mCountRadius + 1 > r0.length) {
            this.mRadius = Arrays.copyOf(r0, r0.length + 1);
        }

        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.MotionEffect_motionEffect_start) {
                    int r4 = a.getInt(attr, this.motionEffectStart);
                    this.motionEffectStart = r4;
                    this.motionEffectStart = Math.max(Math.min(r4, 99), 0);
                } else if (attr == R.styleable.MotionEffect_motionEffect_end) {
                    int r42 = a.getInt(attr, this.motionEffectEnd);
                    this.motionEffectEnd = r42;
                    this.motionEffectEnd = Math.max(Math.min(r42, 99), 0);
            ...
            int r3 = this.motionEffectEnd;
            if (i2 == r3) {
                if (i2 > 0) {
                    this.motionEffectStart = i2 - 1;
                } else {
                    this.motionEffectEnd = r3 + 1;
                }
            }
            a.recycle();
        }
            ...
            if (mc2 == null) {
                ...
                if (!apply) {
                    ...
                    if (r1 == -1) {
                        ...
                        motionLayout.applyViewTransition(r1, mc2);
                    }
                }
            }
            i2++;

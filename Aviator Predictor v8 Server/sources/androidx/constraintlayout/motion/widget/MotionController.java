...
public class MotionController {
    ...
    void buildBounds(float[] bounds, int pointCount) {
        ...
        while (i < r1) {
            ...
            motionController.mStartMotionPath.getBounds(motionController.mInterpolateVariables, motionController.mInterpolateData, bounds, i * 2);
            i++;
            motionController = this;
            r1 = pointCount;
            mils2 = mils;
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!points[j].attributes.containsKey(attributeName) || (attribute = points[j].attributes.get(attributeName)) == null) {
                    ...
                    timeCycleAttributes = timeCycleAttributes2;
                    int[] r3 = this.mAttributeInterpolatorCount;
                    r3[i] = r3[i] + attribute.numberOfInterpolatedValues();
                    break;
                }
            }
            i++;
        ...
        int j2 = 0;
        while (true) {
            int[] r6 = this.mInterpolateVariables;
            if (j2 >= r6.length) {
                break;
            }
            int interpolateVariable = r6[j2];

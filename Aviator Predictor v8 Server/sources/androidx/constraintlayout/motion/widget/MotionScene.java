    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int currentState, Transition transition) {
                int r0 = this.mTargetId;
                View v = r0 == -1 ? motionLayout : motionLayout.findViewById(r0);
                if (v != null) {
                    ...
                    int r1 = this.mMode;
                    boolean z = false;
                    boolean listen = (r1 & 1) != 0 && currentState == start;
                    boolean listen2 = listen | ((r1 & 256) != 0 && currentState == start) | ((r1 & 1) != 0 && currentState == start) | ((r1 & 16) != 0 && currentState == end);
                    if ((r1 & 4096) != 0 && currentState == end) {
                        z = true;
                    }
                    if (listen2 | z) {
                        v.setOnClickListener(this);
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                View v = motionLayout.findViewById(r0);
                if (v == null) {
                    int r1 = this.mTargetId;
            ...
            public void onClick(View view) {
                ...
                if (tl.isInteractionEnabled()) {
                    if (this.mTransition.mConstraintSetStart != -1) {
                        ...
                        boolean forward = ((r2 & 1) == 0 && (r2 & 256) == 0) ? false : true;
                        boolean backward = ((r2 & 16) == 0 && (r2 & 4096) == 0) ? false : true;
                        if (forward && backward) {
                            bidirectional = true;
                        }
                        if (bidirectional) {
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray a) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == R.styleable.Transition_constraintSetEnd) {
                    ...
                    int r2 = a.getInt(attr, this.mDuration);
                    this.mDuration = r2;
                    if (r2 < 8) {
                        this.mDuration = 8;
                    }
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser parser) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.MotionScene_defaultDuration) {
                int r5 = a.getInt(attr, this.mDefaultDuration);
                this.mDefaultDuration = r5;
                if (r5 < 8) {

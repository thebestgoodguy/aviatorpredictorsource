...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            int[] r0 = new int[TransitionState.values().length];
            $SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState = r0;
            try {
                r0[TransitionState.UNDEFINED.ordinal()] = 1;
    ...
    public void setTransition(int transitionId) {
        if (this.mScene != null) {
            ...
            float pos = Float.NaN;
            int r3 = this.mCurrentState;
            if (r3 == this.mBeginState) {
                pos = 0.0f;
            } else if (r3 == this.mEndState) {
                pos = 1.0f;
            }
    ...
    class StateCache {
        ...
        void apply() {
            int r0 = this.startState;
            if (r0 != -1 || this.endState != -1) {
                if (r0 == -1) {
                    MotionLayout.this.transitionToState(this.endState);
                } else {
                    int r2 = this.endState;
                    if (r2 == -1) {
                        MotionLayout.this.setState(r0, -1, -1);
                    } else {
                        MotionLayout.this.setTransition(r0, r2);
                    }
                }
    ...
    */
    ...
    class Model {
        ...
        private void computeStartEndSize(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                ...
                int r3 = (constraintSet == null || constraintSet.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec;
                ConstraintSet constraintSet2 = this.mEnd;
                motionLayout.resolveSystem(constraintWidgetContainer, optimisationLevel, r3, (constraintSet2 == null || constraintSet2.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
            ...
            int r32 = (constraintSet5 == null || constraintSet5.mRotate == 0) ? widthMeasureSpec : heightMeasureSpec;
            ConstraintSet constraintSet6 = this.mEnd;
            motionLayout2.resolveSystem(constraintWidgetContainer2, optimisationLevel, r32, (constraintSet6 == null || constraintSet6.mRotate == 0) ? heightMeasureSpec : widthMeasureSpec);
        }
        ...
        public void build() {
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart == null) {
                        if (!MotionLayout.this.mInRotation) {
                            ...
                            int r9 = MotionLayout.this.mRotatMode;
                            int r10 = MotionLayout.this.mPreRotateWidth;
                            int r16 = MotionLayout.this.mPreRotateHeight;
                            controllers = controllers2;
                            str = MotionLayout.TAG;
                            motionController2.setStartState(viewState, v2, r9, r10, r16);
                        }
                    } else {
            ...
            while (i3 < n) {
                ...
                MotionController controller = controllers4.get(ids[i3]);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mMeasureDuringTransition || setMeasure) {
            ...
            int r8 = this.mWidthMeasureMode;
            if (r8 == Integer.MIN_VALUE || r8 == 0) {
                androidLayoutWidth = (int) (this.mStartWrapWidth + (this.mPostInterpolationPosition * (this.mEndWrapWidth - r8)));
                requestLayout();
            }
            int r82 = this.mHeightMeasureMode;
            if (r82 == Integer.MIN_VALUE || r82 == 0) {
            ...
            for (MotionController motionController : frameArrayList.values()) {
                ...
                if (mode != 0) {
                    ...
                    if (mode >= 1) {
                        ...
                        this.mPaintGraph.setColor(-13391360);
                        int r42 = this.mShadowTranslate;
                        canvas.translate(-r42, -r42);
                        drawAll(canvas, mode, this.mKeyFrameCount, motionController);
                        if (mode == 5) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            int r9 = this.mCurrentState;
            String state3 = r9 == -1 ? "undefined" : Debug.getState(this, r9);
    ...
    void evaluate(boolean force) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (force || this.mTransitionGoalPosition != f))) {
            ...
            if (position <= 0.0f && (r2 = this.mBeginState) != -1 && this.mCurrentState != r2) {
                this.mCurrentState = r2;
                ConstraintSet set = this.mScene.getConstraintSet(r2);
            ...
            if (position >= 1.0d) {
                int r3 = this.mCurrentState;
                int r4 = this.mEndState;
                if (r3 != r4) {
                    this.mCurrentState = r4;
                    ConstraintSet set2 = this.mScene.getConstraintSet(r4);
        ...
        if (f2 >= 1.0f) {
            int r1 = this.mCurrentState;
            int r22 = this.mEndState;
            if (r1 != r22) {
                newState2 = true;
            }
            this.mCurrentState = r22;
        } else if (f2 <= 0.0f) {
            int r12 = this.mCurrentState;
            int r23 = this.mBeginState;
            if (r12 != r23) {
                newState2 = true;
            }
            this.mCurrentState = r23;
        }
    ...
    protected void onAttachedToWindow() {
        ...
        MotionScene motionScene = this.mScene;
        if (motionScene != null && (r1 = this.mCurrentState) != -1) {
            ConstraintSet cSet = motionScene.getConstraintSet(r1);
            this.mScene.readFallback(this);
            ArrayList<MotionHelper> arrayList = this.mDecoratorsHelpers;
            if (arrayList != null) {
                Iterator<MotionHelper> it = arrayList.iterator();
    ...
    void onNewStateAttachHandlers() {
        ...
        int r0 = this.mCurrentState;
        if (r0 != -1) {
            this.mScene.addOnClickListeners(this, r0);
        }
    ...
    protected void fireTransitionCompleted() {
        ...
        if ((this.mTransitionListener != null || ((copyOnWriteArrayList = this.mTransitionListeners) != null && !copyOnWriteArrayList.isEmpty())) && this.mListenerState == -1) {
            ...
            int r3 = this.mCurrentState;
            if (lastState != r3 && r3 != -1) {
                this.mTransitionCompleted.add(Integer.valueOf(r3));
            }
        }
        processTransitionCompleted();
        ...
        int[] r0 = this.mScheduledTransitionTo;
        if (r0 != null && this.mScheduledTransitions > 0) {
            transitionToState(r0[0]);
            int[] r02 = this.mScheduledTransitionTo;
            System.arraycopy(r02, 1, r02, 0, r02.length - 1);
    ...
    public void scheduleTransitionTo(int id) {
        ...
        } else if (r0.length <= this.mScheduledTransitions) {
            this.mScheduledTransitionTo = Arrays.copyOf(r0, r0.length * 2);
        }
        int[] r02 = this.mScheduledTransitionTo;
        int r1 = this.mScheduledTransitions;
        this.mScheduledTransitions = r1 + 1;
        r02[r1] = id;
    }

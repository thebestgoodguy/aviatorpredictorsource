...
public class ViewTransition {
    ...
    static class Animate {
        ...
        void reverse(boolean dir) {
            int r0;
            this.reverse = dir;
            if (dir && (r0 = this.mUpDuration) != -1) {
                this.mDpositionDt = r0 == 0 ? Float.MAX_VALUE : 1.0f / r0;
            }
    ...
    void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        int r5 = this.mViewTransitionMode;
        if (r5 == 2) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        int r0 = this.mDuration;
        if (r0 != -1) {
            transition.setDuration(r0);
        }
    ...
    boolean supports(int action) {
        int r0 = this.mOnStateTransition;
        return r0 == 1 ? action == 0 : r0 == 2 ? action == 1 : r0 == 3 && action == 0;
    }
    ...
    boolean checkTags(View view) {
        int r0 = this.mIfTagSet;
        boolean set = r0 == -1 || view.getTag(r0) != null;
        int r4 = this.mIfTagNotSet;
        boolean notSet = r4 == -1 || view.getTag(r4) == null;
        return set && notSet;
    }
}

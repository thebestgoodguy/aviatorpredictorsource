...
public class ConstraintSet {
    ...
    public static class Layout {
        ...
        public void copyFrom(Layout src) {
            ...
            int[] r0 = src.mReferenceIds;
            if (r0 != null && src.mReferenceIdString == null) {
                this.mReferenceIds = Arrays.copyOf(r0, r0.length);
            } else {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    ...
                    case 76:
                        ...
                        int r62 = mapToConstant.get(attr);
    ...
    public static class Constraint {
        ...
        static class Delta {
            ...
            void printDelta(String tag) {
                Log.v(tag, "int");
                for (int i = 0; i < this.mCountInt; i++) {
                    int r1 = this.mTypeInt[i];
                    int r3 = this.mValueInt[i];
                ...
                for (int i2 = 0; i2 < this.mCountFloat; i2++) {
                    int r12 = this.mTypeFloat[i2];
                    float f = this.mValueFloat[i2];
                ...
                Log.v(tag, "strings");
                for (int i3 = 0; i3 < this.mCountString; i3++) {
                    int r13 = this.mTypeString[i3];
                    String str = this.mValueString[i3];
                ...
                for (int i4 = 0; i4 < this.mCountBoolean; i4++) {
                    int r14 = this.mTypeBoolean[i4];
                    boolean z = this.mValueBoolean[i4];
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            ...
            if (constraint != null) {
                this.mConstraints.put(key, constraint.m5clone());
            }
        }
    }
    ...
    private static void populateOverride(Context ctx, Constraint c, TypedArray a) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (attrType) {
                ...
                default:
                    String hexString = Integer.toHexString(attr);
                    int r11 = mapToConstant.get(attr);
                    StringBuilder sb = new StringBuilder(String.valueOf(hexString).length() + 34);
                    sb.append("Unknown attribute 0x");
                    sb.append(hexString);
                    sb.append("   ");
                ...
                case 87:
                    String hexString2 = Integer.toHexString(attr);
                    int r10 = mapToConstant.get(attr);
                    StringBuilder sb2 = new StringBuilder(String.valueOf(hexString2).length() + 33);
                    sb2.append("unused attribute 0x");
                    sb2.append(hexString2);
                    sb2.append("   ");
    ...
    class WriteXmlEngine {
        ...
        String lookup(int id) {
            try {
                ...
                int r0 = this.unknownCount + 1;
                this.unknownCount = r0;
                StringBuilder sb = new StringBuilder(18);
                sb.append(EnvironmentCompat.MEDIA_UNKNOWN);
                sb.append(r0);
                return sb.toString();
            } catch (Exception e) {
                int r3 = this.unknownCount + 1;
                this.unknownCount = r3;

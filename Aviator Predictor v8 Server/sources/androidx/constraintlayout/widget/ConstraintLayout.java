    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (look) {
                    ...
                    case 30:
                        ...
                        break;
                    case 31:
                        int r10 = a.getInt(attr, 0);
                        this.matchConstraintDefaultWidth = r10;
                        if (r10 == 1) {
                    ...
                    case 32:
                        int r102 = a.getInt(attr, 0);
                        this.matchConstraintDefaultHeight = r102;
                        if (r102 == 1) {
        ...
        public void resolveLayoutDirection(int layoutDirection) {
            ...
            int r6 = this.guideBegin;
            this.resolvedGuideBegin = r6;
            int r7 = this.guideEnd;
            this.resolvedGuideEnd = r7;
            float f2 = this.guidePercent;
            this.resolvedGuidePercent = f2;
            if (isRtl) {
                boolean startEndDefined = false;
                int r11 = this.startToEnd;
                if (r11 != -1) {
                    this.resolvedRightToLeft = r11;
                    startEndDefined = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                } else {
                    int r112 = this.startToStart;
                    if (r112 != -1) {
                        this.resolvedRightToRight = r112;
                        startEndDefined = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                    }
                }
                int r113 = this.endToStart;
                if (r113 != -1) {
                    this.resolvedLeftToRight = r113;
                    startEndDefined = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                }
                int r114 = this.endToEnd;
                if (r114 != -1) {
                    this.resolvedLeftToLeft = r114;
                    startEndDefined = ConstraintLayout.USE_CONSTRAINTS_HELPER;
                }
                int r115 = this.goneStartMargin;
                if (r115 != Integer.MIN_VALUE) {
                    this.resolveGoneRightMargin = r115;
                }
                int r116 = this.goneEndMargin;
                if (r116 != Integer.MIN_VALUE) {
                    this.resolveGoneLeftMargin = r116;
                }
                if (startEndDefined) {
                ...
                if (this.isGuideline && this.orientation == 1) {
                    if (f2 != -1.0f) {
                        ...
                        this.resolvedGuideEnd = r6;
                        this.resolvedGuideBegin = -1;
                        this.resolvedGuidePercent = -1.0f;
                    } else if (r7 != -1) {
                        this.resolvedGuideBegin = r7;
                        this.resolvedGuideEnd = -1;
                        this.resolvedGuidePercent = -1.0f;
                    }
                }
            } else {
                int r4 = this.startToEnd;
                if (r4 != -1) {
                    this.resolvedLeftToRight = r4;
                }
                int r42 = this.startToStart;
                if (r42 != -1) {
                    this.resolvedLeftToLeft = r42;
                }
                int r43 = this.endToStart;
                if (r43 != -1) {
                    this.resolvedRightToLeft = r43;
                }
                int r44 = this.endToEnd;
                if (r44 != -1) {
                    this.resolvedRightToRight = r44;
                }
                int r45 = this.goneStartMargin;
                if (r45 != Integer.MIN_VALUE) {
                    this.resolveGoneLeftMargin = r45;
                }
                int r46 = this.goneEndMargin;
                if (r46 != Integer.MIN_VALUE) {
                    this.resolveGoneRightMargin = r46;
                }
            }
            if (this.endToStart == -1 && this.endToEnd == -1 && this.startToStart == -1 && this.startToEnd == -1) {
                int r47 = this.rightToLeft;
                if (r47 != -1) {
                    this.resolvedRightToLeft = r47;
                    if (this.rightMargin <= 0 && originalRightMargin > 0) {
                        this.rightMargin = originalRightMargin;
                    }
                } else {
                    int r48 = this.rightToRight;
                    if (r48 != -1) {
                        this.resolvedRightToRight = r48;
                        if (this.rightMargin <= 0 && originalRightMargin > 0) {
                            this.rightMargin = originalRightMargin;
                        }
                    }
                }
                int r49 = this.leftToLeft;
                if (r49 != -1) {
                    this.resolvedLeftToLeft = r49;
                ...
                int r410 = this.leftToRight;
                if (r410 != -1) {
                    this.resolvedLeftToRight = r410;
                    if (this.leftMargin <= 0 && originalLeftMargin > 0) {
                        this.leftMargin = originalLeftMargin;
                    }
                }

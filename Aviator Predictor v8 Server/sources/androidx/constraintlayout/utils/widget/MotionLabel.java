...
public class MotionLabel extends View implements FloatLayout {
    ...
    public void setGravity(int gravity) {
        ...
        int r2 = gravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        int r3 = this.mGravity;
        if (r2 != (r3 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK)) {
        }
        if (gravity != r3) {
            invalidate();
        }
    ...
    private void setUpTheme(Context context, AttributeSet attrs) {
        ...
        TextPaint textPaint = this.mPaint;
        int r3 = typedValue.data;
        this.mTextFillColor = r3;

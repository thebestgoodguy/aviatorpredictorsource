...
public class ViewCompat {
    ...
    public static <T extends View> T requireViewById(View view, int r4) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (T) Api28Impl.requireViewById(view, r4);
        }
        T t = (T) view.findViewById(r4);
        if (t == null) {
    ...
    static class Api28Impl {
        ...
        static <T> T requireViewById(View view, int r2) {
            return (T) view.requireViewById(r2);
        }

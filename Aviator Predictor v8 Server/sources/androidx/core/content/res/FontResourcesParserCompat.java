...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        ...
        if (array.hasValue(R.styleable.FontFamilyFont_fontStyle)) {
            r5 = R.styleable.FontFamilyFont_fontStyle;
        } else {
            r5 = R.styleable.FontFamilyFont_android_fontStyle;
        }
        int styleAttr = r5;
        boolean isItalic = 1 == array.getInt(styleAttr, 0);
        if (array.hasValue(R.styleable.FontFamilyFont_ttcIndex)) {
            r6 = R.styleable.FontFamilyFont_ttcIndex;
        } else {
            r6 = R.styleable.FontFamilyFont_android_ttcIndex;
        }
        int ttcIndexAttr = r6;
        if (array.hasValue(R.styleable.FontFamilyFont_fontVariationSettings)) {
            r62 = R.styleable.FontFamilyFont_fontVariationSettings;
        } else {
            r62 = R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        int variationSettingsAttr = r62;
        ...
        if (array.hasValue(R.styleable.FontFamilyFont_font)) {
            r63 = R.styleable.FontFamilyFont_font;
        } else {
            r63 = R.styleable.FontFamilyFont_android_font;
        }
        int resourceAttr = r63;

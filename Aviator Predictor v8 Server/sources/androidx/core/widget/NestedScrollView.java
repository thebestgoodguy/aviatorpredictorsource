...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
            ...
            case 2:
                ...
                if (activePointerIndex == -1) {
                    ...
                    if (!this.mIsBeingDragged) {
                        ...
                        r7[1] = 0;
                        dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, this.mScrollOffset, 0, r7);
                        int r0 = this.mLastMotionY;
                        int[] r1 = this.mScrollOffset;
                        this.mLastMotionY = r0 - r1[1];
    ...
    public void computeScroll() {
        ...
        boolean z = false;
        r3[1] = 0;
        dispatchNestedPreScroll(0, unconsumed, r3, null, 1);
        ...
        if (unconsumed2 != 0) {
            ...
            int[] r7 = this.mScrollConsumed;
            r7[1] = 0;
            dispatchNestedScroll(0, scrolledByMe, 0, unconsumed3, this.mScrollOffset, 1, r7);

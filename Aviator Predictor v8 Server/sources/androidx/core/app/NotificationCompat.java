...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public Builder extend(Builder builder) {
                ...
                int r1 = this.mFlags;
                if (r1 != 1) {
                    wearableBundle.putInt(KEY_FLAGS, r1);
                }
    ...
    public static final class WearableExtender implements Extender {
        ...
        public Builder extend(Builder builder) {
            ...
            if (r12 != 0) {
                wearableBundle.putInt(KEY_CONTENT_ICON, r12);
            }
            int r13 = this.mContentIconGravity;
            if (r13 != 8388613) {
                wearableBundle.putInt(KEY_CONTENT_ICON_GRAVITY, r13);
            }
            int r14 = this.mContentActionIndex;
            if (r14 != -1) {
                wearableBundle.putInt(KEY_CONTENT_ACTION_INDEX, r14);
            }
            int r15 = this.mCustomSizePreset;
            if (r15 != 0) {
                wearableBundle.putInt(KEY_CUSTOM_SIZE_PRESET, r15);
            }
            int r16 = this.mCustomContentHeight;
            if (r16 != 0) {
                wearableBundle.putInt(KEY_CUSTOM_CONTENT_HEIGHT, r16);
            }
            int r17 = this.mGravity;
            if (r17 != 80) {
                wearableBundle.putInt(KEY_GRAVITY, r17);
            }
            int r18 = this.mHintScreenTimeout;
            if (r18 != 0) {
                wearableBundle.putInt(KEY_HINT_SCREEN_TIMEOUT, r18);
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public Builder extend(Builder builder) {
            ...
            int r1 = this.mColor;
            if (r1 != 0) {
                carExtensions.putInt(EXTRA_COLOR, r1);
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    r12 = src.getEditChoicesBeforeSending();
                } else {
                    r12 = 0;
                }
                remoteInputs[i] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, r12, src.getExtras(), null);
            }
        }

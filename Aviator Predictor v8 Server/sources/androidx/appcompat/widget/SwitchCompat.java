...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private boolean hitThumb(float x, float y) {
        ...
        int thumbTop = r2 - r3;
        int thumbLeft = (this.mSwitchLeft + thumbOffset) - r3;
        int r32 = this.mThumbWidth + thumbLeft + this.mTempRect.left + this.mTempRect.right;
        int r5 = this.mTouchSlop;
        int thumbRight = r32 + r5;
        int thumbBottom = this.mSwitchBottom + r5;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & 112) {
            case 16:
                ...
                int r5 = this.mSwitchHeight;
                int switchTop3 = height - (r5 / 2);
                int switchBottom2 = r5 + switchTop3;

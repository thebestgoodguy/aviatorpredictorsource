    ...
    */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (true) {
            ...
            View v = actionMenuView.getChildAt(i);
            if (v.getVisibility() == 8) {
                ...
                if (p.isOverflowButton) {
                    ...
                    if (actionMenuView.hasSupportDividerBeforeChildAt(i)) {
                    ...
                    widthRemaining -= size;
                    actionMenuView.hasSupportDividerBeforeChildAt(i);
                    nonOverflowCount2++;
                }
            }
            i++;
        ...
        int i3 = 0;
        while (i3 < childCount) {
            View v4 = actionMenuView.getChildAt(i3);

...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int majorGravity = r0 & 112;
        int minorGravity = r0 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        switch (majorGravity) {
            case 16:
    ...
    */
    ...
    public void setHorizontalGravity(int horizontalGravity) {
        ...
        int r2 = this.mGravity;
        if ((8388615 & r2) != gravity) {
            this.mGravity = ((-8388616) & r2) | gravity;
            requestLayout();
        }
    }

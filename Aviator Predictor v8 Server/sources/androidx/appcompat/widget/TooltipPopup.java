...
class TooltipPopup {
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) {
        ...
        int[] r8 = this.mTmpAnchorPos;
        int r11 = r8[0];
        int[] r12 = this.mTmpAppPos;
        r8[0] = r11 - r12[0];
        r8[1] = r8[1] - r12[1];
        outParams.x = (r8[0] + offsetX) - (appView.getWidth() / 2);
        int spec = View.MeasureSpec.makeMeasureSpec(0, 0);
        this.mContentView.measure(spec, spec);
        int tooltipHeight = this.mContentView.getMeasuredHeight();
        int[] r122 = this.mTmpAnchorPos;
        int yAbove = ((r122[1] + offsetExtra) - tooltipOffset) - tooltipHeight;
        int yBelow = r122[1] + offsetBelow + tooltipOffset;
        if (!fromTouch) {

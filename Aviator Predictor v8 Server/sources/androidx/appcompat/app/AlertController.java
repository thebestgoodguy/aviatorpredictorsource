    ...
    */
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (hasTextTitle && this.mShowTitle) {
            ...
            int r2 = this.mIconId;
            if (r2 != 0) {
                this.mIconView.setImageResource(r2);
                return;
            }
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        ...
        if (TextUtils.isEmpty(this.mButtonPositiveText) && this.mButtonPositiveIcon == null) {
            ...
            if (drawable != null) {
                int r8 = this.mButtonIconDimen;
                drawable.setBounds(0, 0, r8, r8);
        ...
        if (TextUtils.isEmpty(this.mButtonNegativeText) && this.mButtonNegativeIcon == null) {
            ...
            if (drawable2 != null) {
                int r82 = this.mButtonIconDimen;
                drawable2.setBounds(0, 0, r82, r82);
        ...
        if (TextUtils.isEmpty(this.mButtonNeutralText) && this.mButtonNeutralIcon == null) {
            ...
            if (drawable3 != null) {
                int r83 = this.mButtonIconDimen;
                drawable3.setBounds(0, 0, r83, r83);
    ...
    public static class AlertParams {
        ...
        public void apply(AlertController dialog) {
            ...
            if (view != null) {
                ...
                if (r02 != 0) {
                    dialog.setIcon(dialog.getIconAttributeResId(r02));
                }
            }

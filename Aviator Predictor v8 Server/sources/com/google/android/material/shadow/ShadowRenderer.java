...
public class ShadowRenderer {
    ...
    public void drawEdgeShadow(Canvas canvas, Matrix transform, RectF bounds, int elevation) {
        ...
        int[] r7 = edgeColors;
        r7[0] = this.shadowEndColor;
        r7[1] = this.shadowMiddleColor;
        r7[2] = this.shadowStartColor;
        this.edgeShadowPaint.setShader(new LinearGradient(bounds.left, bounds.top, bounds.left, bounds.bottom, r7, edgePositions, Shader.TileMode.CLAMP));
        canvas.save();
    ...
    public void drawCornerShadow(Canvas canvas, Matrix matrix, RectF bounds, int elevation, float startAngle, float sweepAngle) {
        ...
        if (drawShadowInsideBounds) {
            int[] r6 = cornerColors;
            r6[0] = 0;
            r6[1] = this.shadowEndColor;
            r6[2] = this.shadowMiddleColor;
            r6[3] = this.shadowStartColor;
        } else {
            arcBounds.rewind();
            ...
            int[] r62 = cornerColors;
            r62[0] = 0;
            r62[1] = this.shadowStartColor;
            r62[2] = this.shadowMiddleColor;
            r62[3] = this.shadowEndColor;
        }

...
final class IndicatorViewController {
    ...
    void showHelper(CharSequence helperText) {
        ...
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, helperText));
    }
    ...
    void hideHelperText() {
        ...
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, ""));
    }
    ...
    void showError(CharSequence errorText) {
        ...
        updateCaptionViewsVisibility(r0, this.captionToShow, shouldAnimateCaptionView(this.errorView, errorText));
    }
    ...
    void removeIndicator(TextView indicator, int index) {
        ...
        int r0 = this.indicatorsAdded - 1;
        this.indicatorsAdded = r0;
        setViewGroupGoneIfEmpty(this.indicatorArea, r0);
    }

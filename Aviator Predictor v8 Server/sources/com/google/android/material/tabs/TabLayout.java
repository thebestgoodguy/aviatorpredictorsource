    ...
    */
    ...
    public void setSelectedTabIndicator(Drawable tabSelectedIndicator) {
        if (this.tabSelectedIndicator != tabSelectedIndicator) {
            ...
            int r1 = this.tabIndicatorHeight;
            if (r1 == -1) {
                r1 = gradientDrawable.getIntrinsicHeight();
            }
            int indicatorHeight = r1;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 0) {
            int r5 = this.requestedTabMaxWidth;
            if (r5 <= 0) {
                r5 = (int) (specWidth - ViewUtils.dpToPx(getContext(), 56));
            }
            this.tabMaxWidth = r5;
        }
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        ...
        View nextChild;
        int r0 = this.mode;
        if ((r0 != 0 && r0 != 2) || (selectedChild = this.slidingTabIndicator.getChildAt(position)) == null) {
            return 0;
        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (tabLayout != null) {
                ...
                boolean updateText = r1 != 2 || this.previousScrollState == 1;
                boolean updateIndicator = (r1 == 2 && this.previousScrollState == 0) ? false : true;
        ...
        public void onPageSelected(int position) {
            ...
            if (tabLayout != null && tabLayout.getSelectedTabPosition() != position && position < tabLayout.getTabCount()) {
                int r1 = this.scrollState;
                boolean updateIndicator = r1 == 0 || (r1 == 2 && this.previousScrollState == 0);

    ...
    */
    ...
    private void updateIconPosition(int buttonWidth, int buttonHeight) {
        ...
        if (isIconStart() || isIconEnd()) {
            ...
            int r3 = this.iconGravity;
            if (r3 == 1 || r3 == 3 || ((r3 == 2 && textAlignment == Layout.Alignment.ALIGN_NORMAL) || (this.iconGravity == 4 && textAlignment == Layout.Alignment.ALIGN_OPPOSITE))) {
                this.iconLeft = 0;
                updateIcon(false);
                return;
            }
    ...
    private void updateIcon(boolean needsIconReset) {
        ...
        if (drawable != null) {
            ...
            int r5 = this.iconTop;
            drawable2.setBounds(r4, r5, r4 + width, r5 + height);

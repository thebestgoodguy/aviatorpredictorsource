...
final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    void fillIndicator(Canvas canvas, Paint paint, float startFraction, float endFraction, int color) {
        ...
        int r2 = this.arcDirectionFactor;
        float startDegree = startFraction * 360.0f * r2;
        float arcDegree = endFraction >= startFraction ? (endFraction - startFraction) * 360.0f * r2 : ((endFraction + 1.0f) - startFraction) * 360.0f * r2;

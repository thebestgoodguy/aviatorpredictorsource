...
public class TextAppearance {
    ...
    public void updateDrawState(Context context, TextPaint textPaint, TextAppearanceFontCallback callback) {
        ...
        if (colorStateList != null) {
            r0 = colorStateList.getColorForState(textPaint.drawableState, this.textColor.getDefaultColor());
        } else {
        ...
        if (colorStateList2 != null) {
            r3 = colorStateList2.getColorForState(textPaint.drawableState, this.shadowColor.getDefaultColor());
        } else {
            r3 = 0;
        }
        textPaint.setShadowLayer(f, f2, f3, r3);
    }
    ...
    private boolean shouldLoadFontSynchronously(Context context) {
        ...
        int r0 = this.fontFamilyResourceId;
        if (r0 != 0) {
            typeface = ResourcesCompat.getCachedFont(context, r0);
        } else {
            typeface = null;
        }

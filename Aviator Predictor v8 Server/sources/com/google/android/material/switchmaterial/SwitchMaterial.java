    ...
    */
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            int[][] r4 = ENABLED_CHECKED_STATES;
            int[] switchThumbColorsList = new int[r4.length];
            ...
            this.materialThemeColorsThumbTintList = new ColorStateList(r4, switchThumbColorsList);
        }
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int[] switchTrackColorsList = new int[r0.length];
            int colorSurface = MaterialColors.getColor(this, R.attr.colorSurface);
            int colorControlActivated = MaterialColors.getColor(this, R.attr.colorControlActivated);
            ...
            this.materialThemeColorsTrackTintList = new ColorStateList(r0, switchTrackColorsList);
        }

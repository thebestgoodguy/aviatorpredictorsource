...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        int[] r8 = DISABLED_STATE_SET;
        return new ColorStateList(new int[][]{r8, CHECKED_STATE_SET, EMPTY_STATE_SET}, new int[]{baseColor.getColorForState(r8, defaultColor), colorPrimary, defaultColor});
    }
    ...
    public void buildMenuView() {
        ...
        for (int i = 0; i < this.menu.size(); i++) {
            ...
            int r4 = this.itemPaddingTop;
            if (r4 != -1) {
                child.setItemPaddingTop(r4);
            }
            int r42 = this.itemPaddingBottom;
            if (r42 != -1) {
                child.setItemPaddingBottom(r42);
            }

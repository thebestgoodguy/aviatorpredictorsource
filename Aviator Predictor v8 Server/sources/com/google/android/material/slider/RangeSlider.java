...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public /* bridge */ /* synthetic */ boolean onKeyDown(int r1, KeyEvent keyEvent) {
        return super.onKeyDown(r1, keyEvent);
    }

    @Override // com.google.android.material.slider.BaseSlider, android.view.View, android.view.KeyEvent.Callback
    public /* bridge */ /* synthetic */ boolean onKeyUp(int r1, KeyEvent keyEvent) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        int r1 = savedState.separationUnit;
        this.separationUnit = r1;
        setSeparationUnit(r1);
    }

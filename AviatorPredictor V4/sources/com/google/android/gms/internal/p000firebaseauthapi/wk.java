...
final class wk extends cn {

    /* renamed from: w, reason: collision with root package name */
    private final n0 f2287w;

    public wk(n0 n0Var) {
        super(2);
        this.f2287w = (n0) r.j(n0Var, "credential cannot be null");
    }
    ...
    public final void b(i iVar, bm bmVar) {
        ...
        bmVar.u(new bh(this.f1474d.H0(), this.f2287w), this.f1472b);
    }

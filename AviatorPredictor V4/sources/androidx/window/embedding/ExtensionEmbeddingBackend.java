...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class SplitListenerWrapper {
        ...
        private final j.a<List<SplitInfo>> callback;
        private final Executor executor;
        private List<SplitInfo> lastValue;

        public SplitListenerWrapper(Activity activity, Executor executor, j.a<List<SplitInfo>> aVar) {
        ...
        public final j.a<List<SplitInfo>> getCallback() {
    ...
    @Override // androidx.window.embedding.EmbeddingBackend
    public void registerSplitListenerForActivity(Activity activity, Executor executor, j.a<List<SplitInfo>> aVar) {
        List<SplitInfo> b5;
        i.d(activity, "activity");
        i.d(executor, "executor");
        i.d(aVar, "callback");
        ...
        try {
            ...
            if (this.splitInfoEmbeddingCallback.getLastInfo() != null) {
                b5 = this.splitInfoEmbeddingCallback.getLastInfo();
                i.b(b5);
            } else {
                b5 = l3.i.b();
            }
            splitListenerWrapper.accept(b5);
            s sVar = s.f6374a;
        } finally {
            reentrantLock.unlock();
        }
    ...
    @Override // androidx.window.embedding.EmbeddingBackend
    public void unregisterSplitListenerForActivity(j.a<List<SplitInfo>> aVar) {
        i.d(aVar, "consumer");
        ReentrantLock reentrantLock = globalLock;
        reentrantLock.lock();
        try {

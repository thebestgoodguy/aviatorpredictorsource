...
public interface EmbeddingBackend {
    ...
    void registerSplitListenerForActivity(Activity activity, Executor executor, j.a<List<SplitInfo>> aVar);

    void setSplitRules(Set<? extends EmbeddingRule> set);

    void unregisterRule(EmbeddingRule embeddingRule);

    void unregisterSplitListenerForActivity(j.a<List<SplitInfo>> aVar);
}

...
public class HooActivity extends Activity {
    ...
    /* renamed from: com.my.newproject2.HooActivity$1, reason: invalid class name */
    class AnonymousClass1 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            progressDialog.show();
            HooActivity.this.a = new TimerTask() { // from class: com.my.newproject2.HooActivity.1.1
                @Override // java.util.TimerTask, java.lang.Runnable
                public void run() {
                    HooActivity.this.runOnUiThread(new Runnable() { // from class: com.my.newproject2.HooActivity.1.1.1
            ...
            HooActivity.this._timer.schedule(HooActivity.this.a, 3000L);
        }
    }
